...
print <<<HERE
    | <a href='page_data_edit.php?id=$_SESSION[id]'>Изменить регистрационные данные</a> | <a href='index.php'>Главная страница</a> | <a href='all_users.php'>Список пользователей</a> | <a href='exit.php'>Выход</a> |<br><br>
HERE;
            //выше вывели меню 
...
$tmp = mysql_query("SELECT * FROM messages WHERE recipient='$login' ORDER BY id DESC",$db); 

...
if (empty($myrow['id']))
{
    ...
    exit ("Sorry, entered login or password is incorrect.");
}
else {
...
exit ("Entered loggin or password is incorrect.");
}
else {
...
/* $_SESSION['login']=$myrow['login'];
$_SESSION['id']=$myrow['id'];//эти данные очень часто используются, вот их и будет "носить с собой" вошедший пользователь
echo "You successfully entered to the site <a href='index.php'>Home page</a>";
}
else {
